        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="mb-3">
                    ...
                    @if($data->foto)
                    <img src="{{ asset($data->foto) }}" alt="" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                    @else
                ...
                <select class="form-control" id="kategori_id" name="kategori_id">
                    <option value="">Edit Menu Kategori</option>
                    @foreach ($kategori as $file)
                    <option value="{{$file->id}}" @if($data->kategori_id==$file->id) selected @endif>{{$file->Nama}}</option>
                    @endforeach
                </select>
                </div>
